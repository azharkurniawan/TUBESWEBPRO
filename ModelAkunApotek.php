...
class ModelAkunApotek extends CI_Model {
    public function ambilData($kode){
        $this->db->where('kodeapotek' ,$kode );
        return $this->db->get('tb_akunapotek')->result_array();
    }

    public function masukkanData($data){
        $this->db->insert('tb_akunapotek', $data);
    }

    public function cekData($keyword1){
        $this->db->from('tb_akunapotek');
    ...
    public function updateCus($data, $kodeapotek){
        $this->db->from('tb_akunapotek');
        $this->db->where('kodeapotek', $kodeapotek);
        $this->db->update('tb_akunapotek', $data);
    }
